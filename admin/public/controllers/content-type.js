...
contentTypeControllers.controller('ContentTypeTreeCtrlEdit', ['$scope', '$stateParams', 'ContentType', 'Node', 'DataType', function ($scope, $stateParams, ContentType, Node, DataType) {
